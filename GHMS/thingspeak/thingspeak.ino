...
void connectToThingSpeak(){
  ...
  if (waitResponse("CONNECT OK")) {
    ...
    String data = "api_key=WQN75HY1BHKRMH65&field1=" + String(temperature) + "&field2=" + String(humidity) + "&field3=" + String(level) + "&field4=" + String(moistureValue) + "&field5=" + String(sensorValue) + "&field6=" + String(lightVal);
